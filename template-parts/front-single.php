...
<div class="<?php echo trim($container_class) ?>" <?php echo wp_kses_post(blocksy_sidebar_position_attr()); ?> <?php echo $data_container_output; ?> <?php echo blocksy_get_v_spacing() ?>>
    ...
    <article>
        <div id="velkommen" class="velkommen two_columns">
            <img class="hexagon" src="https://victorhegelund.dk/kea/10_eksamen/p%C3%A6dagogisk-rideterapi/wp-content/uploads/IMG_0135-3.jpg" alt="Maria Knak fra Pædagogisk ridning">
    ...
    <section class="anmeldelser_section" id="anmeldelser">
        <div class="skabelon">
            ...
            <div class="two_columns">
                <img class="hexagon" src="https://victorhegelund.dk/kea/10_eksamen/p%C3%A6dagogisk-rideterapi/wp-content/uploads/anmeldelseEt.jpg" alt="Kvinde anmeldelse af rideterapi">
                ...
                <img class="hexagon" src="https://victorhegelund.dk/kea/10_eksamen/p%C3%A6dagogisk-rideterapi/wp-content/uploads/anmeldelseTo.jpg" alt="Anmeldelse af Pædagogisk ridning">
            </div>
        </div>
    </section>
